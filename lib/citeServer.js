...
http.createServer(function (request, response) {
    ...
    request.on('end', function() {
        ...
        var cslXml;
        //start potentially async process
        //resolve the style ID to the appropriate independent style
        //or skip ahead of style xml was POSTed with request
        var citePromise;
        if(!postedStyle){
            ...
            .then(function(resolvedUrlObj){
                ...
                if(cachedEngine){
                    ...
                    citeprocEngine.sys.items = reqItemsObj;
                    ...
                    .then(function(fetchedCslXml){
                        ...
                        citeprocEngine = new citeprocnode.CiteprocEngine(reqItemsObj, cslXml, requestConfig.locale, localeManager, null);
                        return citeprocEngine;
                    });
                }
            });
        ...
        citePromise.then(function(citeprocEngine){
            ...
            citeprocEngine.cslEngine.updateItems(reqItemIDs);
            ...
            if (requestConfig.citations == "1") {
                ...
                var citations = [];
                if (citationClusters) {
                    for (var i = 0; i < citationClusters.length; i++) {
                        citations.push(citeprocEngine.cslEngine.appendCitationCluster(citationClusters[i], true)[0]);
                    }
                }
                else {
