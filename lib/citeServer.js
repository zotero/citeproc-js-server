...
var cslLoader = new styles.CslLoader(config, "xml");
var jsonCslLoader = new styles.CslLoader(config, "json");
var localeManager = new locales.LocaleManager(config.localesPath, "xml");
var jsonLocaleManager = new locales.LocaleManager(config.jsonLocalesPath, "json");
var engineCache = new enginecaching.QueueCache(config);
