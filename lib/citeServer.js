...
var defaultCiteserverConfig = {
    ...
    "cslPath" : "./csl",
    "jsonLocalesPath" : "./csljson-locales",
    "jsonCslPath" : "./csljson",
...
var cslLoader, jsonCslLoader, localeManager, jsonLocaleManager, engineCache = null;
cslLoader = new styles.CslLoader(config, "xml");
localeManager = new locales.LocaleManager(config.localesPath, "xml");
engineCache = new enginecaching.QueueCache(config);
if(config.localParser == "json"){
    jsonCslLoader = new styles.CslLoader(config, "json");
    jsonLocaleManager = new locales.LocaleManager(config.jsonLocalesPath, "json");
    
    engineCache.cslLoader = jsonCslLoader;
    engineCache.jsonLocaleManager = jsonLocaleManager;
} else {
