...
for (let [param, val] of Object.entries(config) ) {
    log.verbose(`Config param: ${param}`, val);
}
...
var server = http.createServer(function (request, response) {
    ...
    request.on('end', function() {
        ...
        Promise.resolve().then(function(){
            ...
            for (let [param, val] of Object.entries(parsedQuery)) { 
                log.verbose(`parsedQuery param: ${param}`, val);
            }
            ...
            for (let [param, val] of Object.entries(requestConfig)) {
                log.verbose(`Request configuration: ${param}`, val);
            }
